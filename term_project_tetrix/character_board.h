...
private:
  ...
  /* Instance variables */
     ...
     */
    void clearBoard(); //清除面板

    void adjustment();
    void paintPiece(QPainter &painter,QRect& rect,QString comp);
     ...
     * Method: dropToBottom
     * --------------------
     * Moves the piece down to the bottom of the board.
     */
     ...
     * Method: pieceDrop
     * -----------------
     * Drops the piece down number of lines and the number is the parameter
     * dropHeight.
     */
    void pieceDrop(int dropHeight);
